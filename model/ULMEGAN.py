...
class ULMEGANModel(BaseModel):
    """docstring for ULMEGANModel"""
    def __init__(self):
        super(ULMEGANModel, self).__init__()
        self.name = "ULMEGANModel"

    def initialize(self, opt):
        super(ULMEGANModel, self).initialize(opt)
    ...
    def save_ckpt(self, epoch):
        ...
        return super(ULMEGANModel, self).save_ckpt(epoch, save_models_name)
    ...
    def load_ckpt(self, epoch):
        ...
        return super(ULMEGANModel, self).load_ckpt(epoch, load_models_name)

    def clean_ckpt(self, epoch):
        # load the specific part of networks
        load_models_name = ['gen', 'dis']
        return super(ULMEGANModel, self).clean_ckpt(epoch, load_models_name)

    def get_latest_losses(self):
        get_losses_name = ['dis_fake', 'dis_real', 'dis_real_aus', 'gen_rec']
        return super(ULMEGANModel, self).get_latest_losses(get_losses_name)
    ...
    def get_latest_visuals(self):
        ...
        return super(ULMEGANModel, self).get_latest_visuals(visuals_name)
